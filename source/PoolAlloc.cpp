...
const unsigned char TAllocation::preGuardInitialValue = 0xfb;
const unsigned char TAllocation::postGuardInitialValue = 0xfe;
const unsigned char TAllocation::userDataInitialValue = 0xcd;
...
void TAllocation::checkGuardBlock(unsigned char* blockMem, unsigned char val) const
{
...
{
    for (const TAllocation* alloc = this; alloc != 0; alloc = alloc->prev)
        alloc->check();
}
